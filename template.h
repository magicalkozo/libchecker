...
#if defined(USE_DM32)
static inline u32 r1_dm32(u32 mod) { return (u32)(i32)-1 % mod + 1; }
static inline u32 r2_dm32(u32 mod) { return (u64)(i64)-1 % mod + 1; }
static inline u32 r3_dm32(u32 mod, u32 r1, u32 r2) { return (u32)(((u64)r1 * (u64)r2) % mod); }
static inline u32 n_dm32(u32 mod) { return mod; }
static inline u32 ni_dm32(u32 mod) { u32 ni = mod; for (int _ = 0; _ < 4; ++_) ni *= 2 - ni * mod; return ni; }
static inline u32 n2_dm32(u32 mod) { return mod << 1; }
static inline u32 dmr32(u64 a, u32 ni, u32 n) { u32 y = (u32)(a >> 32) - (u32)(((u64)((u32)a * ni) * n) >> 32); return (i32)y < 0 ? y + n : y; }
static inline u32 to_dm32(u32 a, u32 r2, u32 ni, u32 n) { return dmr32((u64)a * r2, ni, n); }
static inline u32 from_dm32(u32 a, u32 ni, u32 n) { return dmr32((u64)a, ni, n); }
...
#if defined(USE_DM64)
static inline u64 r1_dm64(u64 mod) { return (u64)(i64)-1 % mod + 1; }
static inline u64 r2_dm64(u64 mod) { return (u128)(i128)-1 % mod + 1; }
static inline u64 r3_dm64(u64 mod, u64 r1, u64 r2) { return (u64)(((u128)r1 * (u128)r2) % mod); }
static inline u64 n_dm64(u64 mod) { return mod; }
static inline u64 ni_dm64(u64 mod) { u64 ni = mod; for (int _ = 0; _ < 5; ++_) ni *= 2 - ni * mod; return ni; }
static inline u64 n2_dm64(u64 mod) { return mod << 1; }
static inline u64 dmr64(u128 a, u64 ni, u64 n) { u64 y = (u64)(a >> 64) - (u64)(((u128)((u64)a * ni) * n) >> 64); return (i64)y < 0 ? y + n : y; }
static inline u64 to_dm64(u64 a, u64 r2, u64 ni, u64 n) { return dmr64((u128)a * r2, ni, n); }
static inline u64 from_dm64(u64 a, u64 ni, u64 n) { return dmr64((u128)a, ni, n); }
